      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Create personalized magazines for every occasion. From weddings to birthdays, anniversaries to friendships,
            our custom magazines let you tell your unique story with beautiful designs and premium quality.
          </p>
        </div>
