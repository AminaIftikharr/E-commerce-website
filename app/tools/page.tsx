      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Discover our collection of premium craft supplies and tools. From decorative tapes and highlighters to
            stamps and stickers, we have everything you need for your creative projects.
          </p>
        </div>
