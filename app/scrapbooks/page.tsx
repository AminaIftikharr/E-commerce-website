      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Preserve your most precious memories with our personalized scrapbooks. Perfect for babies, couples,
            friendships, and families. Create beautiful memory books with customizable designs and premium quality.
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {scrapbooks.map((product) => (
        ...
        {scrapbooks.length === 0 && (
          <div className="text-center py-12">
            <p className="text-lg text-muted-foreground">No scrapbooks available at the moment.</p>
          </div>
        )}
      </div>
    </div>
